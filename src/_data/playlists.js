...
const CLIENT_ID = '13c7f5ac119c4806b363bc6fd62ec71a';
...
module.exports = async function fetchPlaylists() {
  if (process.env.ELEVENTY_ENV !== 'production') {
    return [
      {
        name: 'フロー flow',
        url: 'https://open.spotify.com/playlist/6ZGjibZYUdb0kkPmqnRmHX',
      ...
      {
        name: 'ローファイ  l o - f i ',
        url: 'https://open.spotify.com/playlist/7ySBYdjfzOOttkZg6Fz5e3',
      ...
      {
        name: '寛ぐ life nostalgia',
        url:
          'https://open.spotify.com/playlist/1fMCmFfrIlUowIEeXeoTqv?si=8088d9928bd146ad',
      ...
      },
      {
        ...
        url: 'https://open.spotify.com/playlist/3zwuJc5WfYTrxyTnrfEZ3Z',
